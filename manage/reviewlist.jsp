...
<td><a href="../review/content.jsp?num=<%= rs.getInt("review_num") %>&nickname=<%= rset.getString("user_nickName")%>"  style="text-decoration:none; color:black">
<%= rs.getString("review_title") %></a></td>
<td><%= rset.getString("user_nickName") %></td>
<td><a href="../review/deleteReview.jsp?num=<%= rs.getInt("review_num") %>">삭제</a></td>
</tr>
<%
	      }
	      rset.close();
